        ...
        <main class="col-md-10 ms-sm-auto px-md-4">
            <div class="pt-3 pb-2 mb-3">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="text-white"><i class="bi bi-plus-circle me-2"></i>Add New City</h2>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h5 class="mb-0"><i class="bi bi-geo-alt me-2"></i>City Information</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('cities/store') ?>" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Enter the city name (e.g., London, Paris, Tokyo)</small>
                                    </div>

                                    <div class="mb-3">
                                        <label for="country_code" class="form-label">Country Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="country_code" name="country_code" 
                                               value="<?= old('country_code') ?>" required maxlength="10">
                                        <small class="text-muted">Enter the country code (e.g., GB, US, JP, FR)</small>
                                    </div>

                                    <div class="d-grid gap-2">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bi bi-check-circle me-2"></i>Add City
                                        </button>
                                        <a href="<?= base_url('cities') ?>" class="btn btn-secondary">
